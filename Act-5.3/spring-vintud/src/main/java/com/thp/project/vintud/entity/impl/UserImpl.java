...
public class UserImpl implements User, Serializable {
    ...
    private List<AnnouncementImpl> favorite_announcements = new ArrayList<>();
    ...
    public List<AnnouncementImpl> getFavorite_announcements() {
        return favorite_announcements;
    }

    public void setFavorite_announcements(List<AnnouncementImpl> favorite_announcements) {
