...
public class SautoLit {
    ...
    static void fileCreate(Scanner sourceFile) {
        while (sourceFile.hasNextLine()) {
            try {
                ...
                myWriter.write(s);
                myWriter.close();
                lecture(new Scanner(Paths.get("C:\\Users\\MED SADDEM\\Desktop\\Talan-Academy-main\\Talan-Academy-main\\Act-2.2\\Act-2.2.5\\Lecture écriture fichier\\monFichier_L" + i + ".txt")));
                String tmpStr = sourceFile.nextLine();
                int charsCount = 0;
                if (!tmpStr.equalsIgnoreCase("")) {
                    String replaceAll = tmpStr.replaceAll("\\p{Punct}", "");
    ...
    static public void main(String[] args) {
        ...
        try {
            ...
            Path path = Paths.get("C:\\Users\\MED SADDEM\\Desktop\\Talan-Academy-main\\Talan-Academy-main\\Act-2.2\\Act-2.2.5\\Lecture écriture fichier\\src\\fichier\\SeLit.java");
