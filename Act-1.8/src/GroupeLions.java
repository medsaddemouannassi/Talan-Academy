...
public class GroupeLions extends GroupePrédateurs implements GroupeLionsAction {
    ...
    @Override
    public void reproduction(Lion lion1, Lion lion2,String sexe, String categorieAge, int force, boolean dominant, String rangDomination, boolean impétuosité, ArrayList<Lion> lionGroup) {
        if ( (lion1.getSexe().equalsIgnoreCase("male") && lion2.getSexe().equalsIgnoreCase("female")) || (lion1.getSexe().equalsIgnoreCase("female") && lion2.getSexe().equalsIgnoreCase("male"))) {
            ...
            System.out.println("Beuuuuurr! Ce n'est pas possible d'avoir un bébé!");
        }
    }
