...
public class Ours extends Prédateur implements OursAction {
    ...
    public void chasser(ArrayList groupe) {
        this.setSolitaire(groupe);
        if (this.isHivernation().equals("en cours") || !this.isSolitaire()) System.out.println("Ce n'est pas le moment!");
        else if (this.isHivernation().equals("terminée")) System.out.println("C'est le moment de la chasse!");
    ...
    @Override
    public void grimper() {
        if (this.isHivernation().equals("en cours")) System.out.println("Ce n'est pas le moment!");
        else if (this.isHivernation().equals("terminée")) System.out.println("Grimper!");
    }

    @Override
    public void creuser() {
        if (this.isHivernation().equals("en cours")) System.out.println("Ce n'est pas le moment!");
        else if (this.isHivernation().equals("terminée")) System.out.println("Creuser!");
    }
    ...
    public void hiverner(boolean hivernation) {
        if (hivernation) {
            this.setHivernation(hivernation);
            System.out.println("Oof! C'est le moment de dormir!!");
        } else {
            this.setHivernation(hivernation);
    ...
    public void seNourrir() {
        if (this.isHivernation().equals("en cours")) System.out.println("Ce n'est pas le moment!");
        else if (this.isHivernation().equals("terminée")) System.out.println("Miam...miam...C'est un avantage d'être un omnivore!");
    }
}
